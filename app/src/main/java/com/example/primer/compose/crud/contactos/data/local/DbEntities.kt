...
fun DoctorEntity.toDoctor(): Doctor = Doctor(
    nombre = this.name,
    detalle = this.specialization,
    phone = this.phone
)
...
@Entity(
    ...
    indices = [Index(value = ["patient_id", "doctor_id"], unique = true)]
)
data class PatientDoctorEntity(
